...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="active"><a href="/admin/userinfoManage"><i class="fa fa-comments"></i> <span>用户管理</span></a></li>
    ...
    <div class="main-content" >
       ...
       <c:forEach items="${list }" var="u" varStatus="s">
        <tr class="gradeX">
          ...
          <td>${u.huifu }</td>
          <td>
          <c:if test="${u.status == 1}">正常用户</c:if>
          <c:if test="${u.status == 2}">封禁用户</c:if>
          </td>
        </tr>
      ...
      <tr>
		<td colspan="8" class="center" > <c:if test="${page.page>1}">
              <a href="/admin/userinfoManage?page=1" >首页</a>
             <a href="/admin/userinfoManage?page=${page.page-1 }"> 上一页</a> 
             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="/admin/userinfoManage?page=${page.page+1 }">下一页</a>
			<a href="/admin/userinfoManage?page=${page.totalPage }">末页</a>
		    </c:if> 
		</td>
      </tr>
        </tbody>
