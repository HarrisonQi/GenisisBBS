    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="active"><a href="/admin/commentManage"><i class="fa fa-globe"></i> <span>评论审核</span></a></li>
    ...
    <div class="main-content" >
       ...
       <c:forEach items="${list }" var="u" varStatus="s">
        <tr class="gradeX">
          ...
          <td>${u.content }</td>
          <td>
          	<a onclick="fengjin(${u.replyUserId },${u.id },1)">删除并封禁用户</a>
          </td>
        </tr>
      ...
      <tr>
		<td colspan="8" class="center" > <c:if test="${page.page>1}">
              <a href="/admin/commentManage?page=1" >首页</a>
             <a href="/admin/commentManage?page=${page.page-1 }"> 上一页</a> 
             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="/admin/commentManage?page=${page.page+1 }">下一页</a>
			<a href="/admin/commentManage?page=${page.totalPage }">末页</a>
		    </c:if> 
		</td>
      </tr>
        </tbody>
...
<script type="text/javascript">
	function fengjin(userid,replyid,type){
		$.ajax({
		       type: "POST",
		       url:"/admin/fengjin",
		       data:{'userid':userid,'replyid':replyid,type:type},
		       dataType:"json",
