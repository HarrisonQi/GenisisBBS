...
<c:if test="${!empty userId}">
    ...
    <div class="panel panel-default" id="sidebar2" style="width: 20%;margin:1% 2% 1% 0%;float: right">
        ...
        <ul class="list-group" style="width: 100%">
            ...
            <li class="list-group-item"><a href="/myTopic/${user.id}">查看发帖</a></li>
            <li class="list-group-item"><a href="/myReplyTopic/${user.id}">查看回帖</a></li>
            <li class="list-group-item"><a href="/myCollections/${user.id}">我的收藏</a></li>
            <li class="list-group-item">个人积分:${user.credit}</li>
        </ul>
    </div>
</c:if>
