    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="active"><a href="/admin/noteManage"><i class="fa fa-retweet"></i> <span>帖子审核</span></a></li>
            </ul>
            <!--sidebar nav end-->
    ...
    <div class="main-content" >
       ...
       <c:forEach items="${list }" var="u" varStatus="s">
        <tr class="gradeX">
          ...
          <td>${u.title }</td>
          <td>
          	<a onclick="fengjin(${u.userId },${u.id },2)">删除并封禁用户</a>
          </td>
        </tr>
      ...
      <tr>
		<td colspan="8" class="center" > <c:if test="${page.page>1}">
              <a href="/admin/noteManage?page=1" >首页</a>
             <a href="/admin/noteManage?page=${page.page-1 }"> 上一页</a> 
             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="/admin/noteManage?page=${page.page+1 }">下一页</a>
			<a href="/admin/noteManage?page=${page.totalPage }">末页</a>
		    </c:if> 
		</td>
      </tr>
        </tbody>
