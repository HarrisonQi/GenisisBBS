...
public class Topic implements Serializable {
	...
	public String toString() {
		return "Topic [user=" + user + ", tab=" + tab + ", countReplies=" + countReplies + ", id=" + id + ", userId="
				+ userId + ", createTime=" + createTime + ", updateTime=" + updateTime + ", title=" + title + ", click="
				+ click + ", tabId=" + tabId + ", content=" + content + ", liang=" + liang + "]";
	}
